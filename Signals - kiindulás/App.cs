...
namespace Signals
{
    ...
    public class App
    {
        ...
        public void NewDocument()
        {
            ...
            Document doc = new SignalDociment(form.DocName); 
            documents.Add(doc);
            createView(doc, true);
        }
        ...
        public void OpenDocument()
        {
            ...
            Console.WriteLine("A dokumentum neve: ");
            Console.WriteLine(path);

            path2 = System.IO.Path.GetFileName(path);

            Document doc = new SignalDociment(path2);
            documents.Add(doc);
            createView(doc, true);

            doc.LoadDocument(path2);
